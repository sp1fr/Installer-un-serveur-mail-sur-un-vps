...
Install_centos7()
{
  ...
  # Désinstallez le postfix fourni avec le système
  if [[ $cpu_arch = "x86_64" && $postfixver != "3.4.7" ]];then
    yum remove postfix -y
    rm -rf /etc/postfix
  fi
  # Installer postfix et postfix-sqlite
...
Install_centos8()
{
  ...
  # Installer dovecot et dovecot-sieve
  yum install dovecot-pigeonhole -y
...
Install()
{
  ...
  # Installer ovecot et dovecot-sieve
